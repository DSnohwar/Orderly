...
const Filters = () => {
  ...
  function handleClick(checkbox) { // function to handle checkboxes click and add their value to query Params
    ...
    if (checkbox.checked == true) { //add the filter to query
      if (queryParams.has(checkbox.name)) {
        queryParams.set(checkbox.name, checkbox.value);
      } else {
        queryParams.append(checkbox.name, checkbox.value);
      }
    } else { //delete the filter from query
  ...
  function handleButtonClick() { //function to handle price filters
    if (typeof window !== "undefined") {
      queryParams = new URLSearchParams(window.location.search);
    }
  ...
  function checkHandler(checkBoxType, checkBoxValue) { //function to handle default check behavior ex. after reloading
    if (typeof window !== "undefined") {
      queryParams = new URLSearchParams(window.location.search);
  ...
  function getPriceQueryParams(queryParams, key, value) { //function to set Price QueryParams
